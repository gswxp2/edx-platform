...
os.environ.setdefault("MYSQL_UNIX_PORT", "/opt/edx/mysql/tmp/mysql.sock")
# Some clouds create /etc/boto.cfg, causing 'boto' import to fail in some cases
os.environ.setdefault("BOTO_CONFIG", "")
os.environ.setdefault("CONFIG_ROOT", "/opt/edx/apps/edx/conf")
os.environ.setdefault("TMPDIR", "/opt/edx/.tmp/")

# New env vars in Juniper
os.environ.setdefault("EDX_PLATFORM_SETTINGS", "bitnami")
os.environ.setdefault("LMS_CFG", "/opt/edx/apps/edx/conf/lms.yml")
os.environ.setdefault("STUDIO_CFG", "/opt/edx/apps/edx/conf/cms.yml")
os.environ.setdefault("REVISION_CFG", "/opt/edx/apps/edx/conf/revision.yml")
